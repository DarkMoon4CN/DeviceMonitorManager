...
namespace ChuanYe.Utils.DEncrypt
{
    public class EncryptForConfig
    {
        const string AES_IV = "5666334456991225";//16位   
        const string key = "cyjhsjxmfzwjjmffxydmyywksyytopgo";//32位   
